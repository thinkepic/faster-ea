<page>
    ...
    <table id="table" style="width: 100%; margin-left: -5px;">
        <tr style="background-color: #f7f7f7; font-weight: bold;">
            ...
            <td style="width: 210px; padding: 5px; font-size: 14px">Items Name</td>
            <td style="width: 10px"></td>
            <td style="width: 400px; padding: 5px; font-size: 14px">Amount</td>
        </tr>
            <tr>
            <td style="width: 10px; padding: 5px; font-size: 14px;">1.</td>
            <td style="width: 210px; padding: 5px; font-size: 14px">Item 1</td>
            <td style="width: 10px">: </td>
            <td style="width: 400px; padding: 5px; font-size: 14px">IDR 500.000</td>
        </tr>
    </table>
    <br><br><br><br><br>
